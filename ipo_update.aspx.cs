...
namespace stock_market_learing
{
    public partial class ipo_update : System.Web.UI.Page
    {
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            if (b1.Text != "" && b2.Text != "" && b3.Text != "" && b4.Text != "" && b5.Text != "" && b6.Text != "" && b7.Text != "" && b8.Text != "" && b9.Text != "" && b10.Text != "")
            {
                string sql = "UPDATE ipo SET [Open Date]='"+b2.Text+ "' , [Close Date]='"+b3.Text+ "', [Listing Date]='"+b4.Text+ "' , [Lot size]='"+b5.Text+ "' , [Allotment]='"+b6.Text+ "' , [Listing At]='"+b7.Text+ "' , [Total Issue Size]='"+b8.Text+ "' , [Credit of Shares to Demat]='"+b9.Text+ "' , [Initiation of Refunds]='"+b10.Text+ "' WHERE  [Company Name]='" + b1.Text + "' ";
        ...
        {
                string sql = "delete from ipo where [Company Name]='" + b1.Text + "' ";
