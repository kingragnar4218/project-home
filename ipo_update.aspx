    ...
    <h2>* Update News *</h2>
      ...
      <div class="form-group">
         ...
         <div class="btn-container">
             ...
             <asp:Button class="btn-containern" ID="Button4" runat="server" Text="Update" OnClick="Button4_Click"  />

             <asp:Button class="btn-containerr" ID="Button3" runat="server" Text="Delete" OnClick="Button3_Click" />
